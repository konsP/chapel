...
static void chpl__init_ChapelNumLocales(int64_t _ln, c_string _fn) {
  ...
  printModuleInit(modFormatStr, modStr, INT64(16));
  ...
  *(refIndentLevel) += INT64(1);
  ...
  if (call_tmp2) {
    ...
    const_tmp = _command_line_cast(call_tmp4);
  }
  numLocales = const_tmp;
  chpl_comm_broadcast_private(INT64(5), sizeof(int64_t), -1);
  *(refIndentLevel) -= INT64(1);
